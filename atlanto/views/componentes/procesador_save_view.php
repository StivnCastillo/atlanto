...
?>
		<div class="tabbable">
			<ul class="nav nav-tabs">
				<li class="active">
					<a href="#tab1" data-toggle="tab"><?php echo $ci->lang->line('tab_comp_pro') ?></a>
				</li>
			</ul>
					...
					<article class="row">
						<form class="form-horizontal" id="frmcomponente" name="frmcomponente" action="<?php echo (isset($componente)) ? $accion_modificar : $accion_guardar; ?>" method="POST">
							<?php if (isset($componente)): ?>
	    						<input type="hidden" name="id_procesador" value="<?php echo $id_procesador; ?>">
	    					<?php endif ?>
							<div class="span5">
								...
								<div class="control-group">
									...
									<div class="controls">
										<div class="input-append">
											<input type="number" class="span2" id="frecuencia" name="frecuencia" value="<?php echo (isset($componente)) ? $componente->frecuencia : ''; ?>" required />
