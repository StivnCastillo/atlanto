...
?>
		<article class="well">
			<form class="form-inline">
				<a href="<?php echo base_url().'dispositivo/nuevo' ?>" id="btn_agregar" class="btn btn-inverse" title="<?php echo $ci->lang->line('lnk_agregar') ?>"><i class="icon icon-plus icon-white"></i></a>
				...
				<tbody>
					...
					<?php if ($dispositivos): ?>
						<?php foreach ($dispositivos as $row): ?>
							<tr>
								<td><?php echo $i; ?> </td>
								<td><a href="<?php echo base_url().'dispositivo/nuevo/'.$row->id ?>"><?php echo $row->nombre; ?></a></td>
								...
								<td class="tabla-center">
									<div class="btn-group">
										<a class="btn btn-small" href="<?php echo base_url().'dispositivo/nuevo/'.$row->id ?>">
										...
										<div id="vnt_eliminar<?php echo $row->id; ?>" class="modal hide fade" >
											...
											<div class="modal-footer">
												...
												<a href="<?php echo base_url().'dispositivo/eliminar/'.$row->id ?>" class="btn btn-primary"><?php echo $ci->lang->line('btn_eliminar'); ?></a>
											</div>
										</div>
