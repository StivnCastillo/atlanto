...
?>
		<article class="well">
			<form class="form-inline">
				<a href="<?php echo base_url().'tipo/nuevo_so' ?>" id="btn_agregar" class="btn btn-inverse" title="<?php echo $ci->lang->line('lnk_agregar') ?>"><i class="icon icon-plus icon-white"></i></a>
				...
				<tbody>
					...
					<?php if ($tipos): ?>
						<?php foreach ($tipos as $row): ?>
							<tr>
								<td><?php echo $i; ?> </td>
								<td><a href="<?php echo base_url().'tipo/nuevo_so/'.$row->id ?>"><?php echo $row->nombre; ?></a></td>
								<td><?php echo $row->descripcion; ?></td><td class="tabla-center">
									<div class="btn-group">
										<a class="btn btn-small" href="<?php echo base_url().'tipo/nuevo_so/'.$row->id ?>">
										...
										<div id="vnt_eliminar<?php echo $row->id; ?>" class="modal hide fade" >
											<div class="modal-header">
												...
												<h3 id="myModalLabel"><?php echo $ci->lang->line('titulo_eliminar_tipo_so'); ?></h3>
											</div>
											...
											<div class="modal-footer">
												...
												<a href="<?php echo base_url().'tipo/eliminar_so/'.$row->id ?>" class="btn btn-primary"><?php echo $ci->lang->line('btn_eliminar'); ?></a>
											</div>
										</div>
