...
?>
		<div class="tabbable">
			<ul class="nav nav-tabs">
				<li class="active">
					<a href="#tab1" data-toggle="tab"><?php echo $ci->lang->line('tab_tel_telefono') ?></a>
				</li>
			</ul>
	    	...
	    	<div class="tab-content">
	    		<div class="tab-pane active" id="tab1">
					<article class="row">
						<form class="form-horizontal" id="frmtelefono" name="frmtelefono" action="<?php echo (isset($telefono)) ? $accion_modificar : $accion_guardar; ?>" method="POST">
							<?php if (isset($telefono)): ?>
	    						<input type="hidden" name="id_telefono" value="<?php echo $id_telefono; ?>">
	    					<?php endif ?>
							<div class="span5">
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" class="span3" id="nombre" name="nombre" value="<?php echo (isset($telefono)) ? $telefono->nombre : ''; ?>" required />
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										...
										<select class="span2" name="ubicacion" id="ubicacion">
											<?php if (isset($telefono)): ?>
												<option value="<?php echo $telefono->id_ubicacion ?>"><?php echo $telefono->ubicacion ?></option>											
											<?php else: ?>
								...
								<div class="control-group">
									...
									<div class="controls">
										...
										<select class="span2" name="usuario" id="usuario">
											<?php if (isset($telefono)): ?>
												<option value="<?php echo $telefono->id_usuario ?>"><?php echo $telefono->usuario ?></option>											
											<?php else: ?>
												<option value=""><?php echo $ci->lang->line('msj_error_resultado'); ?></option>
											<?php endif ?>
										</select>
										...
										<select name="tipo" id="tipo" required>
											...
											<?php if (isset($tipos)): ?>
												<?php foreach ($tipos as $row): ?>
													<option value="<?php echo $row->id; ?>" <?php if(isset($telefono)){if($telefono->id_telefono_tipo == $row->id){echo 'selected="selected"';}} ?> ><?php echo $row->nombre; ?></option>
												<?php endforeach ?>
											<?php else: ?>
												<option value=""><?php echo $ci->lang->line('msj_error_resultado'); ?></option>
											<?php endif ?>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" class="span3" id="ip" name="ip" value="<?php echo (isset($telefono)) ? $telefono->ip : ''; ?>" required />
									</div>
								</div>

								<!-- firmware -->
								<div class="control-group">
									<label class="control-label" for="firmware"><?php echo $ci->lang->line('lbl_firmware') ?></label>
									<div class="controls">
										<input type="text" class="span3" id="firmware" name="firmware" value="<?php echo (isset($telefono)) ? $telefono->firmware : ''; ?>" required />
									</div>
								</div>
							</div>
							...
							<div class="span5">
										...
										<select name="estado" id="estado" required>
											...
											<?php if (isset($estados)): ?>
												<?php foreach ($estados as $row): ?>
													<option value="<?php echo $row->id; ?>" <?php if(isset($telefono)){if($telefono->id_estado == $row->id){echo 'selected="selected"';}} ?>><?php echo $row->nombre; ?></option>
												<?php endforeach ?>
											<?php else: ?>
												<option value=""><?php echo $ci->lang->line('msj_error_resultado'); ?></option>
											<?php endif ?>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" class="span3" id="fabricante" name="fabricante" value="<?php echo (isset($telefono)) ? $telefono->fabricante : ''; ?>" required />
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" class="span3" id="modelo" name="modelo" value="<?php echo (isset($telefono)) ? $telefono->modelo : ''; ?>" required />
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" class="span3" id="serie" name="serie" value="<?php echo (isset($telefono)) ? $telefono->n_serie : ''; ?>" required />
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" class="span3" id="activo" name="activo" value="<?php echo (isset($telefono)) ? $telefono->n_activo : ''; ?>" />
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<textarea class="span3" rows="4" name="comentario" id="comentario"><?php echo (isset($telefono)) ? $telefono->comentarios : ''; ?></textarea>
									</div>
								</div>
								...
								<div class="control-group">
									<div class="controls">
										...
										<a href="<?php echo base_url().'telefono' ?>" class="btn"><?php echo $this->lang->line('btn_cancelar'); ?></a>
									</div>
								</div>
							</div>
