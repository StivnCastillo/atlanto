...
?>
		<article class="well">
			<form class="form-inline">
				<a href="<?php echo base_url().'software/nuevo' ?>" id="btn_agregar" class="btn btn-inverse" title="<?php echo $ci->lang->line('lnk_agregar') ?>"><i class="icon icon-plus icon-white"></i></a>
				...
				<tbody>
					...
					<?php if ($software): ?>
						<?php foreach ($software as $row): ?>
							<tr>
								<td><?php echo $i; ?> </td>
								<td><a href="<?php echo base_url().'software/nuevo/'.$row->id ?>"><?php echo $row->nombre; ?></a></td>
								<td><?php echo $row->version; ?> </td>
								<td><?php echo $row->tipo; ?> </td>
								<td><?php echo $row->estado; ?> </td>							
								<td class="tabla-center">
									<div class="btn-group">
										<a class="btn btn-small" href="<?php echo base_url().'software/nuevo/'.$row->id ?>">
										...
										<div id="vnt_eliminar<?php echo $row->id; ?>" class="modal hide fade" >
											...
											<div class="modal-footer">
												...
												<a href="<?php echo base_url().'software/eliminar/'.$row->id ?>" class="btn btn-primary"><?php echo $ci->lang->line('btn_eliminar'); ?></a>
											</div>
										</div>
